...
-*Переходить по подозрительным ссылкам и скачивать файлы из не проверенных источников.*

-*Сообщать пароли, коды из СМС, данные карт даже «сотрудникам банка» по телефону или знакомым в переписке — так не получится стать жертвой мошенничества.*

-*Оставлять в открытом доступе личные данные (адрес, телефон, дату рождения) и делать профили в соцсетях полностью публичными — это снизит риск возможных атак на основе утечек и настроек приватности.*

-*Вступать в острые конфликты и обмениваться оскорблениями в онлайн-играх и мессенджерах, ведь за экраном может скрываться злоумышленник, а серьезная перепалка способна спроецировать деанон на вас.*

-*Публиковать слишком много личной информации в открытом доступе.*

-*Использовать VPN в публичных сетях, при подключении к общественному WI-FI (кафе, торговый центр). Шифрует весь интернет-трафик устройства.*
